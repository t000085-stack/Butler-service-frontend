...
export default function ConsultationScreen() {
  ...
  const fetchConsultation = async () => {
    ...
    try {
      ...
      setResult({
        empathyStatement: response.empathy_statement || "I'm here to help you get started.",
        microStep: response.micro_step || "Take a deep breath and just start with the smallest step.",
  ...
  const handleReroll = async () => {
    ...
    try {
      ...
      setResult({
        empathyStatement: response.empathy_statement || "I understand, let me suggest something else.",
        microStep: response.micro_step || "Take a deep breath and try this instead.",
        reasoning: response.reasoning || "",
        chosenTaskId: response.chosen_task_id || null,
        contextLogId: response.context_log_id,
      });
